...
export function HostHeader() {
  ...
  return (
    ...
    <header className={`app-header ${isStayPage && !isStayDetailsPage ? 'fixed' : ''}`}>
      <div className='app-header__top-bar'>
        ...
        <nav className='app-header__nav'>
          <div className='app-header__nav-items' ref={navRef}>
            ...
            <NavLink to='/host/orders' className='app-header__nav-item' end>
        ...
        <div className='app-header__profile'>
          <NavLink to='/stay' className='app-header__host'>
            {/* {loggedIn ? 'Switch to traveling' : 'Become a host'} */}
            Switch to traveling
          </NavLink>
      ...
      {/* LoginSignupModal */}
      {isLoginModalOpen && <LoginSignupModal onClose={() => setLoginModalOpen(false)} />}
    </header>
  )
}
