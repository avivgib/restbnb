...
export function StayPreview({ stay, searchDates }) {
  ...
  const queryParams = new URLSearchParams({
    check_in: formatToDateString(suggestedCheckIn) || '',
    check_out: formatToDateString(suggestedCheckOut) || '',
  }).toString()

  return (
    <Link to={`/stay/${stay._id}?${queryParams}`}>
